...
#define Z1_1 0xe9b5dba5
#define Z1_0 0x8189dbbc
#define enc(m, k) _mm512_aesdec_epi128(m, k)
#define xor(a, b) _mm512_xor_si512(a, b)
#define perm4_1302(a) _mm512_permutexvar_epi64(_mm512_set_epi64(2, 3, 6, 7, 0, 1, 4, 5), a)
#define perm4_3012(a) _mm512_permutexvar_epi64(_mm512_set_epi64(6, 7, 0, 1, 2, 3, 4, 5), a)
#define perm4_2301(a) _mm512_permutexvar_epi64(_mm512_set_epi64(4, 5, 6, 7, 0, 1, 2, 3), a)
#define perm4_2031(a) _mm512_permutexvar_epi64(_mm512_set_epi64(4, 5, 0, 1, 6, 7, 2, 3), a)
...
#define UPDATE_STATE(X) \
    ...
    S[0] = xor(tmp7, X[0]);
#define LOAD(src, dst) \
        dst[0] = _mm512_loadu_epi8((const __m512i *)((src))); \
        dst[1] = _mm512_loadu_epi8((const __m512i *)((src) + 64));
#define XOR_STRM(src, dst) \
        dst[0] = xor(src[0], enc(xor(S[0], S[2]), S[1])); \
        dst[1] = xor(src[1], enc(S[1], S[3]));
#define STORE(src, dst) \
        _mm512_storeu_epi8((__m512i *)((dst)), src[0]); \
        _mm512_storeu_epi8((__m512i *)((dst) + 64), src[1]);
#define CAST_U64_TO_M512(v) \
    _mm512_set_epi32((v >> 32) >> 16, (v >> 32) & 0xFFFF, v >> 16, v & 0xFFFF, (v >> 32) >> 16, (v >> 32) & 0xFFFF, v >> 16, v & 0xFFFF, (v >> 32) >> 16, (v >> 32) & 0xFFFF, v >> 16, v & 0xFFFF, (v >> 32) >> 16, (v >> 32) & 0xFFFF, v >> 16, v & 0xFFFF)
